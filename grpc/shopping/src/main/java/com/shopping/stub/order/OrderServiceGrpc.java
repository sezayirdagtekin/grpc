...
public final class OrderServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.shopping.stub.order.OrderService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.shopping.stub.order.OrderRequest,
      com.shopping.stub.order.OrderResponse> getGetOrdersForUserMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getOrdersForUser",
      requestType = com.shopping.stub.order.OrderRequest.class,
      responseType = com.shopping.stub.order.OrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.shopping.stub.order.OrderRequest,
      com.shopping.stub.order.OrderResponse> getGetOrdersForUserMethod() {
    io.grpc.MethodDescriptor<com.shopping.stub.order.OrderRequest, com.shopping.stub.order.OrderResponse> getGetOrdersForUserMethod;
      ...
      synchronized (OrderServiceGrpc.class) {
        if ((getGetOrdersForUserMethod = OrderServiceGrpc.getGetOrdersForUserMethod) == null) {
          OrderServiceGrpc.getGetOrdersForUserMethod = getGetOrdersForUserMethod =
              io.grpc.MethodDescriptor.<com.shopping.stub.order.OrderRequest, com.shopping.stub.order.OrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getOrdersForUser"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.shopping.stub.order.OrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.shopping.stub.order.OrderResponse.getDefaultInstance()))
  ...
  public static abstract class OrderServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getOrdersForUser(com.shopping.stub.order.OrderRequest request,
        io.grpc.stub.StreamObserver<com.shopping.stub.order.OrderResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.shopping.stub.order.OrderRequest,
                com.shopping.stub.order.OrderResponse>(
  ...
  public static final class OrderServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<OrderServiceBlockingStub> {
    ...
    /**
     */
    public com.shopping.stub.order.OrderResponse getOrdersForUser(com.shopping.stub.order.OrderRequest request) {
  ...
  public static final class OrderServiceFutureStub extends io.grpc.stub.AbstractFutureStub<OrderServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.shopping.stub.order.OrderResponse> getOrdersForUser(
        com.shopping.stub.order.OrderRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ORDERS_FOR_USER:
          serviceImpl.getOrdersForUser((com.shopping.stub.order.OrderRequest) request,
              (io.grpc.stub.StreamObserver<com.shopping.stub.order.OrderResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class OrderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.shopping.stub.order.OrderOuterClass.getDescriptor();
    }
